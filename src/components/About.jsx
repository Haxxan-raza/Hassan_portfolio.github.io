  ...
  return (
    <>
      ...
      <p ref={paragraphRef} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        I'm a skilled software developer with experience in  WordPress,JavaScript, and expertise in frameworks 
        like React, Laravel, Vue, and Three.js. I'm a quick learner and collaborate closely with clients to create efficient, 
